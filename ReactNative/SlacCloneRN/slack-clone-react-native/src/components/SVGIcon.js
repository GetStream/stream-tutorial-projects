...
const iconMap = {
  'new-message': [NewMessageBubbleIcon, NewMessageBubbleIconDark],
  'file-attachment': [FileAttachmentIcon, FileAttachmentIconDark],
  'image-attachment': [ImageAttachmentIcon, ImageAttachmentIconDark],
  search: [SearchIcon, SearchIconDark],
  info: [InfoIcon, InfoIconDark],
  emoji: [EmojiIcon, EmojiIconDark],
  threads: [ThreadsIcon, ThreadsIconDark],
  drafts: [DraftsIcon, DraftsIconDark],
  'global-search': [GlobalSearchIcon, GlobalSearchIconDark],
  'dm-tab': [DMTabIcon, DMTabIconDark],
  'home-tab': [HomeTabIcon, HomeTabIconDark],
  'mentions-tab': [MentionsTabIcon, MentionsTabIconDark],
  'you-tab': [YouTabIcon, YouTabIconDark],
  'dm-tab-active': [DMTabIconActive, DMTabIconActiveDark],
  'home-tab-active': [HomeTabIconActive, HomeTabIconActiveDark],
  'mentions-tab-active': [MentionsTabIconActive, MentionsTabIconActiveDark],
  'you-tab-active': [YouTabIconActive, YouTabIconActiveDark],
  away: [AwayIcon, AwayIconDark],
  dnd: [DNDIcon, DNDIconDark],
  notifications: [NotificationsIcon, NotificationsIconDark],
  preferences: [PreferencesIcon, PreferencesIconDark],
  'saved-items': [SavedItemsIcon, SavedItemsIconDark],
  'view-profile': [ViewProfileIcon, ViewProfileIconDark],
  'copy-text': [CopyTextIcon, CopyTextIconDark],
  'delete-text': [DeleteTextIcon, DeleteTextIconDark],
  'edit-text': [EditTextIcon, EditTextIconDark],
};
...
export const SVGIcon = ({type, height, width}) => {
  ...
  const Component = dark ? icons[1] : icons[0];
